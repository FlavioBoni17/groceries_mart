...
<body class="font-sans bg-gray-50">
    <header class="bg-white shadow-md p-4 flex items-center">
        ...
        <div class="ml-4 flex space-x-3">
            <a href="{{url('/login')}}" 
               class="text-blue-500 border border-blue-500 px-4 py-2 rounded text-sm hover:bg-blue-500 hover:text-white transition">Login</a>
            <a href="{{url('/register')}}" 
               class="text-blue-500 border border-blue-500 px-4 py-2 rounded text-sm hover:bg-blue-500 hover:text-white transition">Register</a>
        </div>
    </header>
