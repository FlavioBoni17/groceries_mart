    ...
    <div class="flex items-center justify-center h-screen">
        <div class="bg-white rounded-lg shadow-lg p-8 text-center max-w-sm w-full">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <input type="text" name="phone" class="w-full p-3 mb-4 border border-gray-300 rounded-lg text-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Phone Number" required>
                <input type="text" name="address" class="w-full p-3 mb-4 border border-gray-300 rounded-lg text-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Address" required>
                ...
                <input type="password" name="password_confirmation" class="w-full p-3 mb-6 border border-gray-300 rounded-lg text-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Confirm Password" required>
