...
<body class="bg-gray-100 font-sans">
    ...
    <header class="bg-blue-700 text-white flex justify-between items-center px-6 py-4">
        ...
        <nav class="flex space-x-6">
            ...
            <a href="shop-user.php" class="hover:text-yellow-400">Belanja</a>
            <a href="contact-user.php" class="hover:text-yellow-400">Kontak kami</a>
        </nav>
        <div class="flex items-center space-x-6">
            ...
            <div class="relative flex-grow">
              ...
              class="absolute left-0 top-full mt-1 max-w-2xl bg-white border border-gray-300 rounded shadow-md max-h-48 overflow-y-auto overflow-x-hidden z-10 hidden tex">
              </ul>
            </div>
